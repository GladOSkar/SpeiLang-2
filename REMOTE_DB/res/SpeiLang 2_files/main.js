...
function deletefelge() {
	...
	document.querySelector("#felgenform .delete").className += " expanded";
}

function deletenabe() {
	console.log("Nabe löschen?");
	document.querySelector("#nabenform .delete").className += " expanded";
}

function savefelge() {
	console.log("Felge überschreiben?");
	document.querySelector("#felgenform .save").className += " expanded";
}

function savenabe() {
	console.log("Nabe überschreiben?");
	document.querySelector("#nabenform .save").className += " expanded";
}
...
function parsefiles() {
	...
	document.body.innerHTML += "<script src=\"../db_files/felgenSC-C.json\" type=\"text/javascript\" charset=\"utf-8\"></script>";
	document.body.innerHTML += "<script src=\"../db_files/nabenSC-C.json\" type=\"text/javascript\" charset=\"utf-8\"></script>";
